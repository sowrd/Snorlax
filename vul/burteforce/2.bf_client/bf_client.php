...
<div class="col-xl-8">
    <article class="lyear-arc">
        <div class="arc-header">
            <h2 class="arc-title"><a href="bf_client.php">验证码绕过 (On Client)</a></h2>
            <ul class="arc-meta">
                ...
                <table>
                    ...
                    <tr>
                        <th>
                            ...
                            <input type="text" onclick="createCode()" readonly id="checkCode" style="width: 65px;color: #924B72"/>
                        </th>
                    </tr>
                    <tr>
                        <th>
