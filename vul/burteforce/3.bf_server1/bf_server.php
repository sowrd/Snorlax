...
<div class="col-xl-8">
    <article class="lyear-arc">
        <div class="arc-header">
            <h2 class="arc-title"><a href="bf_server.php">验证码绕过 (On Server 1)</a></h2>
            <ul class="arc-meta">
                ...
                <table>
                    ...
                    <tr>
                        <th>
                            ...
                            <img src="<?php echo $ROOT_DIR;?>inc/bf_vcode1.inc.php" onclick="src='<?php echo $ROOT_DIR;?>inc/bf_vcode1.inc.php?'+new Date().getTime();" />
                        </th>
                    </tr>
                    <tr>
                        <th>
